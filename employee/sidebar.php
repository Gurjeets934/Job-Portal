...
body
  ...
  <body onload="mode()" class='gradient-custom-1' id='bodybg'>
...
<main>
  ...
  echo "
  <div class='d-flex flex-column flex-shrink-0 p-3 text-dark  bg-light' style='width: 280px; height:-web-kit-fill-available; overflow-y:auto ' id='sidenav'>
  <a href='home.php' class='d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark   text-decoration-none' id='navtitle'>
    ...
    <ul class='nav nav-pills flex-column mb-auto text-dark '>
      ...
      <li>
        <a href='jobs.php' class='nav-link text-dark bg-gradient' id='navitem3'>
          <svg class='bi me-2' width='16' height='16'><use xlink:href='#collection'/></svg>
          Jobs
        </a>
      </li>
      <li>
        <a href='messages.php' class='nav-link text-dark bg-gradient' id='navitem4'>
          <svg class='bi me-2' width='16' height='16'><use xlink:href='#chat-quote-fill'/></svg>
          Messages
        </a>
      </li>
      <li>
        <a href='selected.php' class='nav-link text-dark bg-gradient' id='navitem5'>
    ...
    <div class='dropdown' >
      ...
      if($row['pic']==NULL)
      {
        echo "<img src='images/employee.png' alt='' width='32' height='32' class='rounded-circle me-2'>";
      }
      else
      {
        echo "<img src='".$row['pic']."' alt='' width='32' height='32' class='rounded-circle me-2'>";
      ...
      <ul class='dropdown-menu dropdown-menu-light text-small shadow' aria-labelledby='dropdownUser1' id='dropdown'>
        ...
        <li><button class='dropdown-item' href='#' onclick='toggler()' id='darkmode'>Enable Dark Mode</button></li>
