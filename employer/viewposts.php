...
<div class="heading bg-light bg-gradient h-100 w-100 text-center mx-3 mt-2 py-2" id='postsheading'>
    <h3 class='text-warning mx-3 mt-2'>Your Posts</h3>
    <hr class='mx-3'>
<table class="table align-middle mb-0 bg-light" id='posttable'> 
  ...
  <tbody>
    ...
    if($result->num_rows>0)
    {
      ...
      <td><p class='fw-normal   mb-1'><a href='showposts.php?id=$id' class='btn btn-warning btn-sm btn-rounded'>View</a></p>
      <p class='text-muted mb-1'><a href='editposts.php?id=$id' class='btn btn-primary btn-sm btn-rounded'>Edit</a></p>
      <p class='text-muted mb-1'><a href='deleteposts.php?id=$id' class='btn btn-danger btn-sm btn-rounded'>Delete</a></p>
      </td>
      </tr>";
      }
    }
