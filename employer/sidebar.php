...
<body onload="darkmode()" class='gradient-custom-1' id='bodybg'>
...
<main>  
  ...
  echo "<div class='d-flex flex-column flex-shrink-0 p-3 text-dark bg-light' style='width: 280px; height:-web-kit-fill-available; overflow-y:auto ' id='sidenav'>
  <a href='home.php' class='d-flex align-items-center mb-3 mb-md-0 me-md-auto text-dark   text-decoration-none' id='navtitle'>
    <img
           src='../images/logo.png'
           height='60'
         alt='MDB Logo'
     ...
     style='margin-top: -1px;'
      />
      <span class='fs-4' style='margin-left:20px;'>Job Portal</span>
    </a>
    <hr>
    <ul class='nav nav-pills flex-column mb-auto'>
      <li class='nav-item'>
        <a href='home.php' class='nav-link text-dark bg-gradient' id='navitem'>
          <svg class='bi me-2' width='16' height='16'><use xlink:href='#home'/></svg>
          Home
        </a>
      </li>
      <li>
        <a href='dashboard.php' class='nav-link text-dark bg-gradient' id='navitem2'>
          <svg class='bi me-2' width='16' height='16'><use xlink:href='#speedometer2'/></svg>
          Dashboard
        </a>
      </li>
      <li>
        <a href='posts.php' class='nav-link text-dark bg-gradient' id='navitem3'>
          <svg class='bi me-2' width='16' height='16'><use xlink:href='#table'/></svg>
          Add Posts
        </a>
      </li>
      <li>
        <a href='viewposts.php' class='nav-link text-dark bg-gradient' id='navitem4'>
      ...
      <li>
        <a href='applicants.php' class='nav-link text-dark bg-gradient' id='navitem5'>
          <svg class='bi me-2' width='16' height='16'><use xlink:href='#grid'/></svg>
          Applications
        </a>
      </li>
      <li>
        <a href='checkreply.php' class='nav-link text-dark bg-gradient' id='navitem6'>
      ...
      // <li>
      //   <a href='company.php' class='nav-link text-dark bg-gradient' id='navitem6'>
   ...
   echo" </ul>
    ...
    <div class='dropdown' style='margin-bottom:10px;' >
      <a href='#' class='d-flex align-items-center text-dark text-decoration-none dropdown-toggle' id='dropdownUser1' data-bs-toggle='dropdown' aria-expanded='false'>
          ...
          {
            echo "<img src='images/.employer.png' alt='' width='32' height='32' class='rounded-circle me-2'>";
          }
          else
          {
            echo "<img src='".$row['profile']."' alt='' width='32' height='32' class='rounded-circle me-2'>";
      ...
      <ul class='dropdown-menu dropdown-menu-light text-small shadow' aria-labelledby='dropdownUser1' id='dropdown'>
        <li><a class='dropdown-item' href='myprofile.php'>My Profile</a></li>
        <li><a class='dropdown-item' href='editprofile.php'>Edit Profile</a></li>
        <li><button class='dropdown-item' href='#' id='darkmode' onclick='toggler()'>Enable Dark Mode</button></li>
