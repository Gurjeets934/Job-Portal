...
<div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
    <br><br><br><br>
<p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Login for Employers</p>
    
<form class="mx-1 mx-md-4" action="/jobportal/employer/selectemployer.php?<?php htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post" enctype="multipart/form-data">
...
<hr>
<a class='mx-3 text-info' href='forgetpass.php'>Forget Password?</a>
